...
| `MEMORY_NEAR_DUP_THRESHOLD` | 近重复候选阈值 |
| `MEMORY_AUTO_MERGE_THRESHOLD` | 自动合并阈值 |
| `MEMORY_ACCESS_FLUSH_INTERVAL_SECONDS` | 访问统计批量写入间隔 |
| `MEMORY_ACCESS_FLUSH_BATCH` | 访问统计批量写入条数 |
